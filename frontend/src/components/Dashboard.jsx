    ...
    <div className="relative bg-gray-900/80 border border-cyan-500/30 shadow-[0_0_25px_#00ffff40] rounded-3xl p-10 w-[460px] text-white backdrop-blur-md transition-transform hover:scale-105 hover:shadow-[0_0_40px_#00ffff60]">
        ...
        <div className="space-y-3 text-center">
            <div>
                ...
                <span
                className={
                    status.camera ? "text-green-600 font-bold" : "text-gray-500"
                }
                >
                {status.camera ? "Object Detected" : "No Object"}
                </span>
            </div>

            <div>
                <span className="font-semibold">LDR Value:</span>{" "}
                <span className="text-blue-600 font-bold">{status.ldr}</span>
            </div>
            ...
            <div>
                ...
                <span
                className={
                    status.LED ? "text-red-600 font-bold" : "text-gray-500"
                }
                >
                {status.LED ? "ON" : "OFF"}
                </span>
       ...
       <LuRefreshCcw className="animate-slow-spin text-cyan-400" />
